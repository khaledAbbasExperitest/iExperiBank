...
@interface ExperiBankUITests2AllFAils : XCTestCase

@end

@implementation ExperiBankUITests2AllFAils
...
- (void)testFailAfterLongRun{
    ...
    [app launch];
    XCUIElement *usernametextfieldTextField = app.textFields[@"usernameAAATextField"];
    [usernametextfieldTextField tap];
    [usernametextfieldTextField typeText:@"company"];
}
